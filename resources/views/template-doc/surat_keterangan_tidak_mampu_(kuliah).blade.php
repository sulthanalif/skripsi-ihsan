...
<body>
    <div class="container">
        ...
        <p>Berdasarkan surat pengantar dari {{ $fields['pengantar_dari'] }} bahwa benar yang bersangkutan Keluarga yang Tidak Mampu.</p>
        <p>Surat Keterangan ini dipergunakan untuk:</p>
        <p align="center" style="font-weight: bold; font-style: italic;">Persyaratan Pengajuan Bantuan / Pembebasan Biaya Pendidikan Ke Perguruan Tinggi ( KIP Kuliah )</p>
