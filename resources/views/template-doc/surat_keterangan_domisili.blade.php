    ...
    <div class="container">
        ...
        <table class="content-table">
            ...
            <tr>
                ...
                <td>:</td>
                <td>{{ $user['profile']['address_domisili'] }}</td>
            </tr>
        </table>

        <p>Berdasarkan Keterangan dari {{ $fields['keterangan_dari'] }} adalah Benar Orang tersebut diatas pada saat ini BERDOMISILI di {{ $fields['alamat_domisili'] }}</p>
        ...
        <p>Berlaku Sampai Tanggal : {{ $berlaku_hingga }}</p>
