                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control @error('description') is-invalid @enderror" id="description_edit" placeholder="Masukan Deskripsi" cols="30" rows="5" value="{{ old('description') }}"></textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="form-check">
                                    ...
                                    <input type="checkbox" name="status" class="form-check-input @error('status') is-invalid @enderror" id="status_edit" value="1" {{ old('status') ? 'checked' : '' }}>
